...
import com.newemployee.config.handler.TokenToUserDOMethodArgumentResolver;
...
public class MyWebMvcConfigurer implements WebMvcConfigurer {
    ...
    @Autowired
    private TokenToUserDOMethodArgumentResolver tokenToUserMethodArgumentResolver;
